...
export default function SignInForm() {
    ...
    return (
        <div className="w-full max-w-md mx-auto flex flex-col">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6 w-full mt-4">
                {error && (
                ...
                <p className="text-center text-sm text-neutral-600 mt-4">
                    ...
                    <Link href="/sign-up" className="text-neutral-900 hover:text-neutral-600 font-semibold transition-colors underline underline-offset-4">
                        Sign up
                    </Link>
                </p>
            </form>
