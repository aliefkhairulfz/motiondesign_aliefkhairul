            ...
            <section className="relative z-10 pt-18 text-neutral-950 w-full min-h-screen rounded-t-[60px] bg-neutral-100">
                ...
                <footer className="w-full py-24 flex flex-col items-center bg-gradient-to-b from-transparent to-white">
                    ...
                    <div className="flex items-center gap-6 mb-16">
                        <a
                            href="#"
                            className="w-12 h-12 rounded-full bg-gradient-to-b from-orange-500 to-black flex items-center justify-center text-white hover:scale-110 transition-transform shadow-[0_4px_20px_rgba(234,88,12,0.3)]"
                        >
